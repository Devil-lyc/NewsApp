...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideAuthApiService(@AuthRetrofit retrofit: Retrofit): com.example.network.AuthApiService {
        return retrofit.create(com.example.network.AuthApiService::class.java)
    }
    ...
    @Provides
    @Singleton
    fun provideFavoriteApiService(@FavoriteRetrofit retrofit: Retrofit): com.example.network.FavoriteApiService {
        return retrofit.create(com.example.network.FavoriteApiService::class.java)
    }
} 